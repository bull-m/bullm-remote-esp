...
static const unsigned char PROGMEM logo_bmp[] =
        {3, 255, 255, 192, 15, 255, 255, 240, 31, 255, 255, 248, 63, 255, 255, 252, 127, 255, 255, 254, 126, 31, 248,
         126, 252, 31, 248, 63, 252, 31, 248, 63, 252, 0, 0, 63, 252, 0, 0, 63, 252, 30, 120, 63, 252, 30, 120, 63, 252,
         30, 120, 63, 255, 254, 127, 255, 255, 254, 127, 255, 255, 254, 127, 255, 255, 254, 127, 255, 255, 254, 127,
         255, 255, 254, 127, 255, 252, 30, 120, 63, 252, 30, 120, 63, 252, 30, 120, 63, 252, 0, 0, 63, 252, 0, 0, 63,
         252, 31, 248, 63, 252, 31, 248, 63, 126, 31, 248, 126, 127, 255, 255, 254, 63, 255, 255, 252, 31, 255, 255,
         248, 15, 255, 255, 240, 3, 255, 255, 192};
...
void OledReset() {
    ...
    uint8_t address = json["address"].as<uint8_t>();
    if (!I2cScan(address)) {
        ErrorAdd("屏幕无法连接，请检查，如果没有屏幕就到设置中关闭");
        return;
    }
